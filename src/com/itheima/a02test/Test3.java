...
public class Test3 {
    public static void main(String[] args) {
        ...
        Collections.addAll(list1, "蔡坤坤,24","叶咸,23","刘不甜,22","吴签,24","谷嘉,30","肖梁梁,27");
        ...
        Stream<String> stream2 = list2.stream()
                ...
                .skip(1);
        //String -> Actor类型转换，用map，map和Collectors.toMap()不要搞混了，toMap()中才有键的规则，值的规则
        List<Actor> result = Stream.concat(stream1, stream2)
